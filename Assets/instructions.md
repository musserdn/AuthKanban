...
![The Kanban board application displays a Login Required page.](./14-00-unauthenticated-page.png)

![The Kanban board application displays a Login page.](./14-01-login-page.png)

![The Kanban board application includes a main page that displays a list of all tasks sorted into three columns according their statuses.](./14-02-main-page.png)
